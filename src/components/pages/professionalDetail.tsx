    ...
    <div className='flex flex-col items-center lg:gap-[5rem] gap-10 w-full'>
      ...
      <div className={`${isMobile ? 'flex-col items-center' : 'flex-row items-start'} flex lg:w-9/12 w-11/12 z-20 2xl:mt-[-52rem] lg:mt-[-43rem] mt-5`}>
        <div className='flex flex-col 2xl:w-1/4 lg:w-2/5 gap-5 items-center w-3/4'>
          ...
          <div className='text-[#B39659] lg:text-[1.5rem] text-center font-akshar tracking-wide'>{professionalDetail.role}</div>
        ...
        <div className='flex flex-col lg:w-4/5 lg:text-[1.4rem] text-[1.2rem] justify-between gap-5 lg:mt-0 mt-5 text-white'>
          ...
          <BlockContent className='leading-relaxed font-akshar' blocks={professionalDetail?.body} serializers={serializers} />
          ...
          <div className='flex flex-col gap-4 mt-5'>
            ...
            <div className={`${showEducationAccordion? '' : 'hidden'} font-akshar w-5/6`}>
          ...
          {/* <div className='flex flex-col gap-4 mt-5'>
            ...
            <div className={`${showExperienceAccordion? '' : 'hidden'} font-akshar w-5/6`}>
